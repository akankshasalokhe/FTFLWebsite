...
const BlogPage = () => {
  ...
  // SEO: Generate structured data for all blog posts
  const generateStructuredData = () => {
    ...
    const structuredData = {
      ...
      "@type": "Blog",
      "name": "FTFL Technology Blog",
      "description": "Insights, ideas and stories from FTFL Technology team",
      "url": "https://www.ftfltechnology.com/blog",
      "publisher": {
        "@type": "Organization",
      ...
      "blogPost": blogData.map(post => ({
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": `https://www.ftfltechnology.com/blog/${post._id}`
        },
        "image": post.headingImage,
  ...
  // SEO: Generate meta description from blog content
  const generateMetaDescription = () => {
    if (blogData.length > 0) {
      const latestPosts = blogData.slice(0, 3).map(post => post.title).join(", ");
      return `FTFL Technology Blog - Read our latest articles on ${latestPosts}. Discover insights on web development, design, and technology trends.`;
    }
    return "FTFL Technology Blog - Discover the latest trends, insights, and best practices from our team of experts in web development and technology.";
  };
  ...
  // Get all featured posts that match the active category
  const featuredPosts = blogData.filter(post =>
    post.featured && (activeCategory === "All" || post.category === activeCategory)
  );

  // Limit to 2 posts only for "All" category
  const displayFeaturedPosts = activeCategory === "All"
  ...
  const handleSearch = (query) => {
    ...
    setShowSearchResults(!!query.trim()); // Show results when there's a query
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <Head>
        {/* Primary SEO Tags */}
        <title>FTFL Technology Blog - Web Development, Design & Technology Insights</title>
        <meta name="description" content={metaDescription} />
        <meta name="keywords" content="web development, technology blog, programming, design, react, nextjs, javascript, ftfl technology" />

        {/* Open Graph Tags */}
        <meta property="og:title" content="FTFL Technology Blog - Web Development & Technology Insights" />
        <meta property="og:description" content={metaDescription} />
        <meta property="og:url" content="https://www.ftfltechnology.com/blog" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.ftfltechnology.com/og-image.jpg" />
        <meta property="og:site_name" content="FTFL Technology" />

        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="FTFL Technology Blog" />
        <meta name="twitter:description" content={metaDescription} />
        <meta name="twitter:image" content="https://www.ftfltechnology.com/twitter-image.jpg" />

        {/* Canonical URL */}
        <link rel="canonical" href="https://www.ftfltechnology.com/blog" />
        ...
        <meta name="author" content="FTFL Technology" />
      ...
      {/* Your existing animated background bubbles */}
      <div className="fixed inset-0 pointer-events-none z-0">
        {[...Array(25)].map((_, i) => (
          <motion.div
            key={i}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <section className="mb-16 text-center">
          ...
          <motion.h1 // Changed to h1 for SEO
            ...
            className="text-5xl md:text-6xl font-bold text-gray-900 mb-6"
          >
            Explore Our <span className="bg-clip-text text-transparent bg-blue-600">Technology</span> Blog
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl text-gray-600 max-w-3xl mx-auto"
          >
            Discover the latest trends, insights, and best practices in web development,
            design, and technology from our team of experts at FTFL Technology.
          </motion.p>
              ...
              >
                ...
                >
                  <div className="h-80 relative overflow-hidden">
                    <motion.img
                      src={post.headingImage}
                      alt={post.title} // SEO: Always use descriptive alt text
                      className="w-full h-full object-cover"
                      variants={imageHoverVariants}
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-70"></div>
        ...
        >
          ...
          <AnimatePresence mode="wait">
            {searchedPosts.length === 0 ? (
              ...
              >
                {searchedPosts.map((post, index) => (
                  <motion.article // Use article tag for SEO
                    key={post._id}
                    variants={itemVariants}
                    layout
                    className="bg-white/80 backdrop-blur-sm rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100"
...
// Add your animation variants here (they were missing from your code)
const containerVariants = {
  hidden: { opacity: 0 },
  visible: {
    opacity: 1,
