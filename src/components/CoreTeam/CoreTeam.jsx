...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
  {filteredMembers.map((member, index) => (
    ...
    >
      ...
      {/* Profile Image */}
      <div className="w-40 h-40 mb-4 rounded-lg overflow-hidden border-4 border-white ring-4 ring-blue-100 shadow-lg z-10">
        <img
          src={member.mainImage}
          alt={member.fullName}
          className="w-full h-full object-cover"
      ...
      <p className="text-white text-sm mb-4 line-clamp-3 z-10">
        {member.description}
      </p>
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
  {filteredMembers.map((member, index) => (
    ...
    >
      {/* Left Panel: Full-size Image with Overlay */}
      <div className="w-1/2 flex-shrink-0 relative group">
        <img
          src={member.mainImage}
          alt={member.fullName}
        ...
        <div className="absolute inset-x-0 bottom-0 p-4 bg-gray-900 bg-opacity-70 text-white transform translate-y-full transition-transform duration-500 group-hover:translate-y-0">
