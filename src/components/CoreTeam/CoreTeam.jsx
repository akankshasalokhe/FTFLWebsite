                ...
                <div className="bg-gray-100 rounded-xl p-1.5 inline-flex min-w-max space-x-1">
                  {roles.map((role, i) => (
                    <button
                      ...
                      className={`px-3 py-2 sm:px-4 sm:py-2.5 rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 whitespace-nowrap min-w-max ${activeRole === role
                          ? "bg-white text-blue-600 shadow-md shadow-blue-100"
                          : "text-gray-600 hover:text-gray-900 hover:bg-white/50"
                        }`}
                    >
