...
//         {/* Team Members Grid - No Carousel */}
//       <div className="relative">
//   <div className={`grid gap-4 sm:gap-6 ${filteredMembers.length === 1
//     ? 'grid-cols-1 justify-items-center'
//     : filteredMembers.length === 2
...
//         transition={{ duration: 0.4, delay: index * 0.1 }}
//         whileHover={{ y: -5 }}
//         className="group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 w-full"
//         ref={el => cardRefs.current[index] = el}
//       >
//         {/* Image Container - Remove extra padding/margin */}
//         <div
//           className="relative w-full h-56 sm:h-64 overflow-hidden flex items-center justify-center bg-white p-0"
//           onTouchStart={() => handleCardTouch(index)}
//         >
//           <img
//             src={member.mainImage}
