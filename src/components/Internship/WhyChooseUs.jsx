  ...
  const highlights = [
    {
      ...
      description: "Work on live industrial project and gain practical knowledge on trending technologies.",
    },
    {
      id: 2,
      icon: <FaLaptopCode className="text-white text-3xl" />,
      title: "Networking ",
      description: "Establish your connection with professional experts and expand your network.",
    },
    {
      id: 3,
      icon: <FaUserTie className="text-white text-3xl" />,
      title: "Improvement In Employability",
      description: "Boost your ability for job prospects with relevant industrial skills",
    },
    {
      id: 4,
      icon: <FaBuilding className="text-white text-3xl" />,
      title: "Skill Development",
      description: "Grow your existing skill and acquire new competencies. ",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        >
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#298cf3] to-blue-600">
            {/* KickStart Your Journey<br />Shape Your Future */} Why Choose Our Program
          </span>
        </motion.h2>
