...
// //     <div 
// //       onClick={handleClick}
// //       className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl hover:text-white hover:bg-blue-400 transition-all duration-300 cursor-pointer hover:border-blue-200 group"
// //     >
...
// //         </div>
// //       </div>
// //       <h3 className="text-xl font-bold text-gray-900 mb-3 leading-tight group-hover:text-white">
// //         {role.title}
// //       </h3>
// //       <p className="text-blue-600 font-semibold text-lg group-hover:text-white">
// //         {role.jobCount} Jobs Available
// //       </p>
// //     </div>
// //   );
// // }
...
//                  hover:shadow-xl hover:text-white hover:bg-blue-400 
//                  active:bg-blue-400 active:text-white active:shadow-xl
//                  transition-all duration-300 cursor-pointer 
//                  hover:border-blue-200 active:border-blue-200 group"
//     >
//       <div className="flex items-center justify-between mb-4">
//         <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center 
//                        group-hover:bg-blue-100 group-active:bg-blue-100 
...
//       {[...Array(8)].map((_, index) => (
//         <div key={index} className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 animate-pulse">
//           <div className="flex items-center justify-between mb-4">
...
//         {/* Header - Double heading like in the image */}
