...
const MissionSection = () => {
  ...
  return (
    <section
      id="values-section"
      className="pt-8 pb-12 sm:pt-10 sm:pb-16 lg:pt-10 lg:pb-16 px-4 sm:px-6 lg:px-4  bg-gradient-to-b from-blue-50 via-white to-blue-50"
    >
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-12 lg:mb-14">
        ...
        {/* Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-25 me-10 -ms-8">
          {content.map((item, index) => (
            <div
              key={index}
