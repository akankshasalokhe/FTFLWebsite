...
const MissionSection = () => {
  ...
  return (
    <section
      id="values-section"
      className="pt-4 pb-16 sm:pt-6 sm:pb-20 lg:pt-8 lg:pb-24 px-4 sm:px-6 lg:px-8 bg-white"
    >
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          ...
          {content.map((item, index) => (
            ...
            >
              ...
              <img
                src={item.image}
                alt={item.title}
                className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:-translate-x-6"
                loading="lazy"
              />

              {/* Black background only on hover */}
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-90 transition-opacity duration-500"></div>
