...
// <div className={`p-4 sm:p-6 flex flex-col flex-grow ${!isMobile ? "md:w-1/2" : ""}`}>
//   <h3 className={`text-lg sm:text-xl font-bold mb-2 text-gray-900 line-clamp-2 ${!isMobile ? "lg:text-2xl lg:mb-3" : ""}`}>
//     {product.title}
//   </h3>
//   <p className={`text-xs sm:text-sm text-gray-500 mb-3 line-clamp-2 ${!isMobile ? "lg:text-base lg:mb-4" : ""}`}>
//     {product.subTitle}
//   </p>

//   <p className={`text-gray-600 mb-4 leading-relaxed text-sm sm:text-base ${!isMobile ? "lg:text-lg lg:mb-6" : ""}`}>
//     {isMobile
//       ? `${product.description.substring(0, Math.floor(product.description.length / 2))}...`
//       : `${product.description.substring(0, 180)}${product.description.length > 80
//                   }`}...
...
//   <div className={`mb-4 sm:mb-6 ${!isMobile ? "lg:mb-8" : ""}`}>
//     <h4 className={`font-semibold text-gray-800 mb-2 text-sm sm:text-base ${!isMobile ? "lg:text-lg lg:mb-3" : ""}`}>
//       Key Features:
//     </h4>
//     <div className={`flex flex-wrap gap-2 ${!isMobile ? "lg:gap-3" : ""}`}>
//       {product.homeFeatureTags
//         ?.slice(0, isMobile ? 3 : product.homeFeatureTags.length)
//         .map((feature, i) => (
//           <span
      ...
      >
        {productsData.map((product, index) => (
          ...
          >
            ...
            >
              <h3
                className={`text-lg sm:text-xl font-bold mb-2 text-gray-900 line-clamp-2 ${
                  !isMobile ? "lg:text-2xl lg:mb-3" : ""
                }`}
              >
                {product.title}
              </h3>
              <p
                className={`text-xs sm:text-sm text-gray-500 mb-3 line-clamp-2 ${
                  !isMobile ? "lg:text-base lg:mb-4" : ""
                }`}
              >
                {product.subTitle}
              </p>
                  ...
                  {product.homeFeatureTags
                    ...
                    .map((feature, i) => (
                      <span
                        key={i}
                        className={`bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs sm:text-sm whitespace-nowrap ${
                          !isMobile ? "lg:px-3 lg:py-2 lg:text-base" : ""
                        }`}
                      >
                        {feature}
                      </span>
