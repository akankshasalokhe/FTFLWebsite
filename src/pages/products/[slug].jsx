...
const products = {
  'fetch-true': {
    ...
    screenshots: [
      '/images/fetch-true-dashboard.jpg',
      '/images/fetch-true-analytics.jpg',
      '/images/fetch-true-mobile.jpg'
    ],
    stats: [
  ...
  'spark': {
    ...
    screenshots: [
      '/images/spark-matches.jpg',
      '/images/spark-profile.jpg',
      '/images/spark-chat.jpg'
    ],
    stats: [
            ...
            >
              ...
              <div className="aspect-w-16 aspect-h-9 bg-black">
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-white text-lg">Product demo video</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
                ...
                >
                  ...
                  {product.demoVideo && (
                    <div className="rounded-xl overflow-hidden bg-gray-100 border border-gray-200 aspect-w-16 aspect-h-9 cursor-pointer" onClick={() => setVideoPlaying(true)}>
                      ...
                      <img src={product.screenshots[0]} alt="Video thumbnail" className="w-full h-full object-cover" />
                    </div>
                  )}
                </motion.div>
              )}
